...
function Publica() {
  ...
  if (cargando) return (
    <div
      ...
      style={{
        backgroundImage: `linear-gradient(rgba(0,0,0,0.75), rgba(0,0,0,0.75)), url('https://images.unsplash.com/photo-1507842217343-583bb7270b66?w=1600')`,
  ...
  return (
    ...
    >
      {/* Header público */}
      <div
        className="border-b border-orange-300 px-8 py-4 flex justify-between items-center"
      ...
      >
        ...
        <div className="flex gap-3">
          <Link
            to="/registro"
            className="border-2 border-orange-300 text-orange-300 px-4 py-2 rounded-full font-bold hover:bg-orange-300 hover:text-black text-sm transition-all"
          >
            Registrarse
          </Link>
          <Link
            to="/login"
            className="bg-orange-300 text-black px-4 py-2 rounded-full font-bold hover:bg-orange-400 text-sm transition-all"
          >
            Iniciar Sesión
          </Link>
        </div>
      ...
      <div className="p-10">
        <h2 className="text-4xl font-bold text-orange-300 mb-2">
          Todos los Poemas
        </h2>
